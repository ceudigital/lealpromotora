...
//Configure::write('Config.language', 'deu');
     ...
     */
    Configure::write('Security.salt', 'S6x)x5q8ScZNL0Y5rc1Zi_d*W07v7IO3(A)tGP#T%XFst@zse5JsS2tQmhiKH&ha');

    /**
     * A random numeric string (digits only) used to encrypt/decrypt strings.
     */
    Configure::write('Security.cipherSeed', '93964762638449302777319844807144');
